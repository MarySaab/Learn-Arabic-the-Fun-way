    ...
    <section className="container">
      ...
      <header style={{ textAlign: "center", maxWidth: "56ch", margin: "0 auto 32px" }}>
        ...
        <p style={{ color: "var(--teal)" }}>
          أربعة أقسام — قراءة وكتابة وإملاء وقواعد — ستة عشر سؤالاً متدرّج
          الصعوبة. ستحصل على مستوى عامّ ومستوى لكلّ مهارة (A، B، C، D)، وإن
          لم تعرف الإجابة فاختر «لا أعرف» بكلّ راحة — هذا يساعدنا على تحديد
          مستواك بدقّة.
        </p>
      </header>
      <TestRunner />
